# Generated by Django 5.2 on 2025-07-25 22:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dietary_tags', models.JSONField(blank=True, default=list, help_text="List of dietary tags (e.g., ['vegetarian', 'vegan', 'gluten-free'])")),
                ('allergens', models.JSONField(blank=True, default=list, help_text="List of common allergens (e.g., ['nuts', 'peanuts'])")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dietary_preferences', models.JSONField(blank=True, default=list, help_text="List of dietary preferences (e.g., ['vegetarian', 'vegan', 'pescatarian'])")),
                ('allergies_intolerances', models.JSONField(blank=True, default=list, help_text="List of allergies and intolerances (e.g., ['nuts', 'peanuts', 'dairy'])")),
                ('cuisine_preferences', models.JSONField(blank=True, default=list, help_text="List of cuisine preferences (e.g., ['italian', 'mexican'])")),
                ('disliked_ingredients', models.JSONField(blank=True, default=list, help_text="List of disliked ingredients (e.g., ['garlic', 'onions'])")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_time_minutes', models.PositiveIntegerField(default=35)),
                ...
                ('embedding_vector', models.JSONField(blank=True, default=list, help_text='OpenAI embedding vector (1536 floats)')),
